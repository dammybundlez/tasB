...
const Header = () => {
  ...
  return (
    <header className="bg-white sticky top-0 z-10 flex justify-between">
      <div className="container shadow-md mx-auto lg:px-10 p-2 py-4 flex justify-between items-center">
        <h1 className="lg:text-3xl text-xl font-bold text-[#000]"><Link to='/'>🍽 Tasty<span className="text-yellow-400">Bits</span></Link></h1>
        <nav className="lg:block hidden">
          <ul className="flex gap-4 text-gray-700 uppercase">
            <li><Link to="/" className="hover:text-pink-600">Home</Link></li>
            <li><Link to="/about" className="hover:text-pink-600">About</Link></li>
            <li><Link to="/recipes" className="hover:text-pink-600">Recipes</Link></li>
            <li><Link to="/favorites" className="hover:text-pink-600">Favourites</Link></li>
          </ul>
        </nav> 
